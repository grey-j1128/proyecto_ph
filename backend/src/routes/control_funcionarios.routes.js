...
import {
  getControlFuncionario,
  getControlFuncionarios,
  insertControlFuncionario,
  updateControlFuncionario,
  deleteControlFuncionario,
...
routerControlFuncionario.put(
  ...
  asyncHandler(async (req, res) => {
    ...
    try {
      let row = await updateControlFuncionario(
...
routerControlFuncionario.delete(
  "/control_funcionario/:id",
  asyncHandler(async (req, res) => {
    let idControlFuncionario = parseInt(req.params["id"]);
    if (isNaN(idControlFuncionario)) {
